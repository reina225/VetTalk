                            ...
                            <div class="tab-content">
                              <!-- 1ST TAB -->
                                <div class="tab-pane fade in mt-2" id="medicine">
                                  <div class="row">
                                    ...
                                    ?>
                              <!-- 2ND TAB -->
                                <div class="tab-pane fade in mt-2" id="vitamins">
                                  <div class="row">
                              ...
                              <!-- 4th TAB -->
                                <div class="tab-pane fade in mt-2" id="catfood">
                                  <div class="row">
                              ...
                              <!-- 5th TAB -->
                                <div class="tab-pane fade in mt-2" id="dogfood">
                                  <div class="row">
                              ...
                              <!-- 6th TAB -->
                                <div class="tab-pane fade in mt-2" id="treats">
                                  <div class="row">
                              ...
                              <!-- 7th TAB -->
                                <div class="tab-pane fade in mt-2" id="petsupplies">
                                  <div class="row">
                              ...
                              <!-- 8th TAB -->
                                <div class="tab-pane fade in mt-2" id="petaccessories">
                                  <div class="row">
