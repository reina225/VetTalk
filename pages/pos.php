                    ...
                    <h4 class="m-1 text-lg text-primary">Product category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#medicine" data-toggle="tab">Medicine</a>
                              </li>
                              <li class="nav-item">
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="#treats" data-toggle="tab">Treats</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#petsupplies" data-toggle="tab">Pet Supplies</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#petaccessories" data-toggle="tab">Pet Accessories</a>
                              </li>
