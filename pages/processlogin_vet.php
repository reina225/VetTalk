...
//create some sql statement             
        $sql = "SELECT ID,e.FIRST_NAME,e.LAST_NAME,e.GENDER,e.EMAIL,e.PHONE_NUMBER,r.JOB_TITLE,l.PROVINCE,l.CITY,t.TYPE
        FROM  `users` u
        ...
        elseif ($_SESSION['TYPE']=='Veterinarian'){
          ...
          elseif ($_SESSION['TYPE']=='Lab_Staff'){
