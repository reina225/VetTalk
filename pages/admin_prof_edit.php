      ...
      ?>
        ...
        <div class="card shadow mb-4 col-xs-12 col-md-12 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Admin Profile</h4>
            </div>
            <div class="card-body">
      

            <form role="form" method="post" action="admin_prof_edit_1.php">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Role" name="role" value="<?php echo $l; ?>" readonly>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
